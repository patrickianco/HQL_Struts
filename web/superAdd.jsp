...
<html>
    ...
    <body>
        <img class="img-responsive mx-auto d-block" src="assets/img/flogo.png" style="width:30%">
        <div class="container">
              <div class="card">
                  <div class="card-header text-center">
                      <div class="row">
                        <div class="col-md-11"><h3 class="">Add User</h3></div>
                        <div class="col-md-1 text-center "><button class="btn btn-danger goBack" onclick="location.href='superHome.jsp'">Go back</button></div>
                      </div>
                  </div>
                  <div class="card-block">
                    <form class="form-horizontal" action="SuperAdd" method="POST">
